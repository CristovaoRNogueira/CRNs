        ...
        <div id="content" class="site-content">
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    <?php 
                    $hero_title = get_theme_mod( 'set_hero_title', __( 'Please, type some title', 'crns' ) );
                    $hero_subtitle = get_theme_mod( 'set_hero_subtitle', __( 'Please, type some subtitle', 'crns' ) );
                    $hero_button_link = get_theme_mod( 'set_hero_button_link', '#' );
                    $hero_button_text = get_theme_mod( 'set_hero_button_text', __( 'Learn More', 'crns' ) );
                    ...
                    <section class="services">
                        <h2><?php esc_html_e( 'Services', 'crns' ) ?></h2>
                        <div class="container">
                    ...
                    <section class="home-blog">
                        <h2><?php esc_html_e( 'Latest News', 'crns' ) ?></h2>
                        <div class="container">
                            <?php 
